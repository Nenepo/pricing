...
function App() {
  ...
  return (
    <div className="w-full  flex justify-center items-center flex-col py-[40px] px-5">
      ...
      <h1 className="text-4xl font-semibold mt-4 ">
        Good, fast, cheap.
        <span className=" font-normal libre"><br/> Pick two</span>
      </h1>
              ...
              <div className="bg-white p-4 flex flex-col gap-4 ">
                ...
                <ul className="text-gray-800 gap-2 flex flex-col text-xs ">
                  ...
                  {current.features.map((feat, idx) => {
                    const isStrikethrough = feat.text
                      .trimStart()
                      .startsWith("~");
